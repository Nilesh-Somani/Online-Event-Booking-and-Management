            ...
            <main className="pt-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                        {[
                            ["Upcoming Events", "2", <EventsIcon />, "bg-blue-100", "text-blue-600"],
                            ["Total Bookings", "12", <AttendeesIcon />, "bg-green-100", "text-green-600"],
                            ["Active Tickets", "3", <ViewIcon />, "bg-purple-100", "text-purple-600"],
                            ["Saved Events", "5", <TotalEventsIcon />, "bg-orange-100", "text-orange-600"],
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <div className="bg-white border rounded-lg p-6 mb-8">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    {[
                                        ["My Bookings", <AttendeesIcon />, "bg-green-50", "hover:bg-green-100", "text-green-600", "text-green-700", "/mybookings"],
                                        ["Browse Events", <EventsIcon />, "bg-blue-50", "hover:bg-blue-100", "text-blue-600", "text-blue-700", "/events"],
                                        ["Analytics", <AnalyticsIcon />, "bg-purple-50", "hover:bg-purple-100", "text-purple-600", "text-purple-700", "/analytics"],
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-white border rounded-lg p-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Link className="flex items-center p-2 hover:bg-gray-100 rounded-lg" to="/mybookings">
                                        <AttendeesIcon className="mr-3" />
                                        Browse All Bookings
                                    </Link>
                                    <Link className="flex items-center p-2 hover:bg-gray-100 rounded-lg" to="/analytics">
